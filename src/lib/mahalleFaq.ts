import type { Mahalle } from "@/data/mahalleler";
  ...
  const faqs: MahalleFaqItem[] = [
    {
      ...
      answer: `${mahalle.name} Mahallesi'nin muhtarı ${mahalle.muhtar.name}'dır. Kendisine ${mahalle.muhtar.mobile} numaralı telefondan ulaşabilirsiniz.`,
    },
    {
      id: "nufus",
